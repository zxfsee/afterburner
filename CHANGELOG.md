...
- Deployment verification handoff transport locator history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification handoff transport locator changes so downstream deployment tooling can audit transport-facing locator updates without reading shell or process logs.
  - Kind: `mixed`
...
- Deployment verification evidence bundle transport locator adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one stable transport-facing locator over the deployment verification evidence bundle so downstream deployment consumers can resolve the current verification bundle without hardcoding artifact paths.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification evidence bundle transport locator reconciliation adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one reconciliation artifact over the deployment verification evidence bundle transport locator so downstream deployment consumers can compare desired transport-facing locator state against the current locator without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification evidence bundle transport locator history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification evidence bundle transport locator changes so downstream deployment tooling can audit transport-facing locator updates without reading shell or process logs.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification receipt transport locator adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one stable transport-facing locator over the deployment verification receipt so downstream deployment consumers can resolve the current verification receipt without hardcoding artifact paths.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification receipt transport locator reconciliation adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one reconciliation artifact over the deployment verification receipt transport locator so downstream deployment consumers can compare desired transport-facing locator state against the current locator without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification receipt transport locator history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification receipt transport locator changes so downstream deployment tooling can audit transport-facing locator updates without reading shell or process logs.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

<!-- queue-snapshot: todo_sha256=aac41b978c370be8f29ed3b381bd8b3d3a50e9ddf18b8d813f31e53a1bdc6684 parent_commit=f6013f2eae2c216e2f4f23f530d3582f0524ed6b -->
