...
- Artifact cleanup execution receipt adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize the execution-side cleanup receipt over an approved dry-run plan so actual removals and skips become inspectable and auditable instead of living in shell history and operator memory.
  - Kind: `mixed`
