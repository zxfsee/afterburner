...
- Deployment verification bundle core grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse the deployment-verification bundle, bundle-history, bundle-reconciliation, and bundle-transport-locator recipe expansion into grouped `just` entrypoints backed by typed helpers so `justfile` stops mirroring bundle artifact taxonomy directly across the core bundle surface.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `cli`
  - Scope: `justfile`, `src/`, `tests/`, `docs/workflows.md`, `docs/reference.md`

- Deployment verification bundle locator and rollback grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse the deployment-verification bundle locator, locator rollback, and rollback supersession recipe expansion into grouped `just` entrypoints backed by typed helpers so the remaining bundle-side mutation surface stops carrying a hand-expanded command registry.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `cli`
  - Scope: `justfile`, `src/`, `tests/`, `docs/workflows.md`, `docs/reference.md`

- Deployment verification handoff grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse the deployment-verification handoff noun-variant recipe expansion into grouped `just` entrypoints backed by typed helpers so `justfile` stops carrying a hand-expanded handoff command registry.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `cli`
  - Scope: `justfile`, `src/`, `tests/`, `docs/workflows.md`, `docs/reference.md`
...
<!-- queue-snapshot: todo_sha256=0018b8a695e9259ced49de50637c48c1953446c3b1705e5d47fea21a9c2efac3 parent_commit=f39698cdb9152f1c07d24957c060c578faa11425 -->
