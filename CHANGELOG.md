...
- Grouped reference validation wording alignment [Runtime Infra]
  - Goal: Keep the cross-family reference validation gate aligned with the newer grouped operator-flow wording so it checks current docs intent instead of stale “entrypoint map” and “recipe map” phrases.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/reference_doc_validation.rs`

- Grouped deployment matrix validation wording alignment [Serving/Deployment Infra]
  - Goal: Keep the shared deployment-matrix validation aligned with the current grouped operator-flow wording so the matrix gate no longer lags behind the family-level docs phrasing.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/deployment_matrix_workflow_surface.rs`

- Grouped source/lineage reference wording tightening [Data Infra, Distributed Training]
  - Goal: Keep the remaining source and lineage reference wording concise and operator-centered by trimming leftover “entrypoint map” phrasing in grouped reference notes.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
...
<!-- queue-snapshot: todo_sha256=47ed996fa7d5337d903bc8c3cee40e5c2ac5c555efa7491d20fd1bc1ed00cc23 parent_commit=26bf6781d4f61e049191a381e7b615195bd6177d -->
