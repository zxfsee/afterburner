...
- Queue in-flight top-scope repair hardening [Runtime Infra]
  - Goal: Let `queue-fix-top-scope` repair active TODO metadata even when legitimate in-scope worktree changes already exist, so a late-discovered scope widening does not force a manual lock clear before the metadata repair can land.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `ops`
  - Scope: `Cargo.toml`, `CHANGELOG.md`, `justfile`, `src/bin/workflow_objective_lock.rs`, `docs/workflows.md`, `tests/objective_lock.rs`, `tests/developer_workflows.rs`

<!-- queue-snapshot: todo_sha256=a4340ad9b246c3cac81f0d4746f499eefcd63f29528e1c97db571203c8f7847e parent_commit=c9cbd52c5cee4d88f18f24d67fc3276423e4f842 -->
