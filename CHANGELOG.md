...
- Deployment verification receipt rollback adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one rollback artifact over the deployment verification receipt so downstream deployment consumers can restore the previous verification receipt state without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`
...
<!-- queue-snapshot: todo_sha256=c1c09ee56a2d6e92010d7fd59ed564e6eea1c1ff1c53cc6ad4a4ebb8c1006b37 parent_commit=e355d4d8e9396c7ac8b710919a0cad29ea130287 -->
