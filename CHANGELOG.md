...
- Command-input helper rollout for deployment stack launch [Runtime Infra, Serving/Deployment Infra]
  - Goal: Extend the shared command-input helper surface through the deployment-stack launch family so those artifact-heavy variants stop carrying local JSON object loader, string/u64 reader, and history helper logic.
  - Kind: `mixed`
  - Boundary: `none`
  - Contracts: `artifact`, `event`
  - Scope: `src/`, `tests/`

- Command-input helper rollout for lineage and kube lease [Runtime Infra, Serving/Deployment Infra]
  - Goal: Extend the shared command-input helper surface through the distributed shard-lineage and kube lease families after the deployment-stack launch slice lands.
  - Kind: `mixed`
  - Boundary: `none`
  - Contracts: `artifact`, `event`
  - Scope: `src/`, `tests/`
...
<!-- queue-snapshot: todo_sha256=4dda53400de5d8cfc71ab8cad790ab0eb2df47389d7f93dab5832e065a344eb6 parent_commit=ace3a724a45a778432243fd2a849e2f398bf407b -->
