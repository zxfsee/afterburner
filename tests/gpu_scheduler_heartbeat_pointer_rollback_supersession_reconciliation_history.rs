...
#[test]
fn gpu_scheduler_heartbeat_pointer_rollback_supersession_reconciliation_history_schema_is_explicit()
{
...
fn gpu_scheduler_heartbeat_pointer_rollback_supersession_reconciliation_history_writes_history_and_event()
 {
  ...
  "reconciliation_status": "aligned"
    ...
    cmd.arg("debug")
        ...
        .arg("point-record-rollback-supersession-reconciliation-history")
        .arg("--reconciliation")
        .arg(&reconciliation)
        .arg("--event")
        .arg("reconciled")
