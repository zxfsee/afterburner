...
- Reference index coverage gate [Runtime Infra, Serving/Deployment Infra]
  - Goal: Keep `docs/reference.md` aligned with the contract and capability surfaces that README points to so the frontpage can stay concise without losing discoverability of artifact, workflow, and stance contracts.
  - Kind: `gate`
  - Boundary: `none`
  - Contracts: `none`
