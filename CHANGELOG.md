...
- Inference drift comparison receipt contract [Inference, Experimentation/Eval Infra]
  - Goal: Define a pass/fail receipt for comparing candidate and current infer-output drift summaries so rollout checks can make explicit promotion decisions without parsing raw logits or ad-hoc diffs.
  - Kind: `mixed`
