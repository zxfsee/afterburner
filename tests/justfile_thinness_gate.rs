...
fn justfile_thinness_debt_stays_bounded() {
    ...
    let allowed_expanded = BTreeSet::from([
        ...
        "deployment-verification-receipt-rollback current_pointer restored_pointer rolled_back_at_unix_ms".to_string(),
        "deployment-verification-receipt-rollback-history rollback event recorded_at_unix_ms".to_string(),
