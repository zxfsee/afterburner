...
- Deploy verification and heartbeat grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse deployment-verification and scheduler-heartbeat noun-variant recipe expansion into grouped `just` entrypoints backed by typed helpers so `justfile` stops mirroring internal artifact taxonomy directly across the deploy-side family surface.
  - Kind: `mixed`
...
<!-- queue-snapshot: todo_sha256=1c09d049bebc8f713b62ae312792f2c9dbaaee17313dba1a4bad67ef4e17b30d parent_commit=c9346c55274c5a29e8d8cc5fd1615d3f3d0a6b73 -->
