...
- Deployment verification evidence bundle rollback adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one rollback artifact over the deployment verification evidence bundle so downstream deployment consumers can restore the previous verification bundle state without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

<!-- queue-snapshot: todo_sha256=a0f809ed1f06a848ac8ece8cb027d55601c5568d3eeaadaaa654d8b939f09ac1 parent_commit=6e623025999c4f0e913b8785002797e14c85d52a -->
