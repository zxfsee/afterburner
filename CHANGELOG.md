...
- Queue completion-boundary shared-docs hardening [Runtime Infra]
  - Goal: Prevent false completion-boundary violations when unrelated queue items touch shared workflow/reference docs or broad test directories by hardening the queue snapshot guard around docs-family TODO scopes.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `ops`
  - Scope: `src/bin/workflow_queue_snapshot.rs`, `tests/queue_snapshot.rs`, `Cargo.toml`
...
<!-- queue-snapshot: todo_sha256=9a28027e7b1aa3cb03bfc216d538947ec8ca7e9f9c45f603d37c21a20622e382 parent_commit=f36c96daeaf1d31d75d3495ccdddff8f80161bd5 -->
