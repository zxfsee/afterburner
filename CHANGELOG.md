...
- Burn stable release availability gate [Frameworks, Runtime Infra]
  - Goal: Materialize one explicit repo gate that records whether a newer stable Burn release beyond `0.20.1` is available so the `.bpk` migration stays blocked on checked evidence instead of TODO text alone.
  - Kind: `gate`
  - Boundary: `core-contract`
  - Contracts: `none`
  - Scope: `tests/`, `docs/adr/`, `docs/reference.md`, `docs/workflows.md`
...
- Burn `.bpk` artifact migration contract [Frameworks, Runtime Infra]
  ...
  - Blocked-by: Burn stable release availability gate; newer stable Burn release after `0.20.1`; see ADR-033.
...
<!-- queue-snapshot: todo_sha256=42620ad104a9a77845bf9b85f0b7273e0da5ea7ac7930f816a8a2884f646337b parent_commit=d00e760afd500ec3397188d73ed57018d442d2f5 -->
