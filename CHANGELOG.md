...
- Grouped cleanup section split validation gate alignment [Runtime Infra]
  - Goal: Keep the shared README/reference split validator aligned with the cleanup section heading so the grouped cleanup reference surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`
...
- Grouped profiling section split validation gate alignment [Runtime Infra]
  - Goal: Keep the shared README/reference split validator aligned with the profiling section heading and family artifacts so the grouped profiling reference surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

<!-- queue-snapshot: todo_sha256=1b0ed50cb5232d28e1d597f7b5c97a5d84e4bfcf22f555ec9805b093fb112a83 parent_commit=5c8e9a86fe4b2ac104ecabc2c7411d563f4d912b -->
