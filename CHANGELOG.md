...
- Queue top-scope carry-forward hardening [Runtime Infra]
  - Goal: Let top-scope metadata repair and execute preflight cooperate cleanly when queue metadata widens mid-work, so the repaired `CHANGELOG.md` baseline and updated active scope can carry forward without a manual lock-clear detour.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `ops`
  - Scope: `Cargo.toml`, `CHANGELOG.md`, `justfile`, `src/bin/workflow_queue_snapshot.rs`, `docs/workflows.md`, `tests/queue_snapshot.rs`, `tests/developer_workflows.rs`
...
<!-- queue-snapshot: todo_sha256=366aaa78e244c0e558f8766617a8d5d2ae095852c9f15313297974eae75273f7 parent_commit=0e8c35cfdaa84464fa7f0684fdba56488cdf37c5 -->
