    ...
    I: Iterator<Item = String>,
{
    ...
    let dry_run_receipt = load_json_object(
        args.dry_run_receipt_path.as_path(),
        "cleanup dry-run receipt",
    )?;
...
afterburner::define_command_input_json_helpers!(CleanupExecuteError);
