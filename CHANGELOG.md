...
- Deployment verification evidence bundle rollback supersession adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one supersession artifact over deployment verification evidence bundle rollback records so downstream deployment consumers can identify which rollback record remains current without ad hoc shell checks.
  - Kind: `mixed`
...
- Deployment verification receipt rollback supersession adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one supersession artifact over deployment verification receipt rollback records so downstream deployment consumers can identify which rollback record remains current without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification evidence bundle rollback supersession history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification evidence bundle rollback supersession changes so downstream deployment tooling can audit current-rollback selection changes without reading shell or process logs.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification receipt rollback supersession history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification receipt rollback supersession changes so downstream deployment tooling can audit current-rollback selection changes without reading shell or process logs.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification evidence bundle rollback supersession reconciliation adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one reconciliation artifact over deployment verification evidence bundle rollback supersession state so downstream deployment consumers can compare desired current-rollback selection against the current supersession artifact without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification receipt rollback supersession reconciliation adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one reconciliation artifact over deployment verification receipt rollback supersession state so downstream deployment consumers can compare desired current-rollback selection against the current supersession artifact without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

<!-- queue-snapshot: todo_sha256=3f95166626edeb42bd806a8c4f10579544abbc98f8fe65507f4c98b2b3c07ef0 parent_commit=4389b4bf4eab81b1837e8fe5da1f99fbdc147971 -->
