...
- Debug deploy command taxonomy regrouping [Serving/Deployment Infra, Runtime Infra]
  - Goal: Regroup the low-level debug deploy command tree around clearer action/object boundaries so long internal artifact noun chains stop leaking directly into the CLI path even on internal surfaces.
  - Kind: `mixed`
  - Boundary: `none`
  - Contracts: `cli`
  - Scope: `src/cli_dispatch/`, `src/main.rs`, `justfile`, `tests/`, `docs/reference.md`, `docs/workflows.md`
...
- Command-input helper rollout beyond scheduler and verification [Runtime Infra, Serving/Deployment Infra]
  - Goal: Extend the shared command-input helper surface into the remaining artifact-heavy command families so deployment-stack, distributed-lineage, drift, and cleanup variants stop carrying their own JSON object loader and field-reader logic.
  - Kind: `mixed`
  - Boundary: `none`
...
<!-- queue-snapshot: todo_sha256=7d42c9b7f95b28a9b5e24fd1853ecc4b0eee48616e610e3463011b574173bcec parent_commit=5d7b665a31aff65787ff5b7fbb152ac804fe77a6 -->
