...
- Deployment verification receipt locator and rollback grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse the deployment-verification receipt locator, locator rollback, and rollback supersession recipe expansion into grouped `just` entrypoints backed by typed helpers so the remaining receipt-side mutation surface stops carrying a hand-expanded command registry.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `cli`
  - Scope: `justfile`, `src/`, `tests/`, `docs/workflows.md`, `docs/reference.md`

- Deployment verification bundle grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse the deployment-verification bundle noun-variant recipe expansion into grouped `just` entrypoints backed by typed helpers so `justfile` stops mirroring bundle artifact taxonomy directly.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `cli`
  - Scope: `justfile`, `src/`, `tests/`, `docs/workflows.md`, `docs/reference.md`
...
<!-- queue-snapshot: todo_sha256=38335561e594c2c5c61d989c451691551bc6aa7ddd05c137c5efb29fc4f55d39 parent_commit=3f372416cb137ac39842d0570215f4abdd349c33 -->
