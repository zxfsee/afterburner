...
- Inference drift approval supersession contract [Inference, Experimentation/Eval Infra]
  - Goal: Define how a newer baseline approval supersedes an older one so rollout tooling can follow one explicit approved baseline lineage instead of competing approval records.
  - Kind: `mixed`
