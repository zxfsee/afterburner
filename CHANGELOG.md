...
- README GitHub frontpage completion pass [Runtime Infra, Serving/Deployment Infra]
  - Goal: Finish `README.md` as a GitHub frontpage by keeping the first screen concise, moving the remaining contract-heavy operational/reference material into `docs/`, and leaving README as a navigation document rather than an internal reference notebook.
  - Kind: `gate`
  - Boundary: `none`
  - Contracts: `none`
  - Scope: `README.md`, `docs/`, `tests/`
