...
- Deploy family grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse deploy, verification, heartbeat, and lineage noun-variant recipe expansion into grouped `just` entrypoints backed by typed helpers so `justfile` stops mirroring internal artifact taxonomy directly.
  - Kind: `mixed`
...
<!-- queue-snapshot: todo_sha256=317c88d104106534e622ec8e900139986a1a803cabe895ebe4f6abe918e24029 parent_commit=d3456a2fb274d10d66ca07be11f5694fc5f1b6bd -->
