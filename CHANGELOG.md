...
- Grouped profiling reference split validation gate alignment [Runtime Infra]
  - Goal: Keep the shared README/reference split validator aligned with the profiling reference family so profiling artifact groups cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

<!-- queue-snapshot: todo_sha256=48b3c1515f9b7b9fa1fa0986813285d6939530fec2c7170c5e031c630d6899a2 parent_commit=35cd02013d4cb939748ee0ebd1502608982505d7 -->
