...
afterburner::define_command_input_json_kind_history_helpers!(
    DeploymentVerificationBundleLocatorRollbackHistoryError,
    "deployment verification bundle locator rollback",
    "deployment verification bundle locator rollback history"
);
