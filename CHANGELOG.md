...
- Pretraining source provenance evidence bundle adapter [Data Infra, Pre-training]
  - Goal: Package pretraining source approval and provenance receipts into one stable bundle artifact so downstream dataset review tooling can consume a single entrypoint instead of chasing separate approval artifacts manually.
  - Kind: `mixed`
