...
#[test]
fn deployment_verification_bundle_rollback_supersession_reconciliation_schema_and_workflow_are_explicit()
 {
    ...
    assert!(
        ...
        "justfile must expose the deployment-verification-reconcile-bundle-rollback-supersession workflow"
    );
    ...
    assert!(
        ...
        "workflow reference must mention the deployment verification bundle rollback supersession reconciliation artifact"
    );
    assert!(
        workflows.contains("just deployment-verification-reconcile-bundle-rollback-supersession"),
        "workflow reference must mention the deployment verification bundle rollback supersession reconciliation workflow"
    );
}
