...
- If a docs cleanup moves operational or contract-heavy detail out of `README.md`, move the corresponding test/assertion ownership to the new doc surface too; do not leave README duplicated just to satisfy stale README-only checks.
