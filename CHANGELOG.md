...
- Artifact cleanup dry-run receipt [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize a cleanup dry-run receipt over the existing inventory and policy artifacts so removal planning becomes inspectable and repeatable instead of living in operator judgment and README prose.
  - Kind: `mixed`
