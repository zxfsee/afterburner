...
- Deployment verification receipt core grouped entrypoint extraction [Runtime Infra, Serving/Deployment Infra]
  - Goal: Collapse the deployment-verification receipt, receipt-history, receipt-reconciliation, and receipt-transport-locator recipe expansion into grouped `just` entrypoints backed by typed helpers so `justfile` stops mirroring receipt artifact taxonomy directly across the core receipt surface.
  - Kind: `mixed`
...
<!-- queue-snapshot: todo_sha256=34f5cd1b9e3b0040112d5ce89b6ceebcb0375b490c89960c8ac2c7defcfadc96 parent_commit=e723d146af0040c32396afa0df8d93a35f8caf65 -->
