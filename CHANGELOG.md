...
- Inference drift baseline transport locator contract [Inference, Serving/Deployment Infra]
  - Goal: Define a transport-facing locator artifact for the approved drift baseline handoff so deployment-side workflows can resolve one stable handoff entrypoint without reading the full drift-management bundle directly.
  - Kind: `mixed`
