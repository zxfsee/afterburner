...
- Deployment verification evidence bundle transport locator reconciliation history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification evidence bundle transport locator reconciliation changes so downstream deployment tooling can audit desired-versus-current transport-facing locator updates without reading shell or process logs.
  - Kind: `mixed`
...
- Deployment verification receipt transport locator reconciliation history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification receipt transport locator reconciliation changes so downstream deployment tooling can audit desired-versus-current transport-facing locator updates without reading shell or process logs.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification evidence bundle locator pointer adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one stable current-pointer artifact over the deployment verification evidence bundle transport locator so downstream deployment consumers can resolve the current verification bundle locator without hardcoding locator paths.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification receipt locator pointer adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one stable current-pointer artifact over the deployment verification receipt transport locator so downstream deployment consumers can resolve the current verification receipt locator without hardcoding locator paths.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification evidence bundle locator pointer reconciliation adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one reconciliation artifact over the deployment verification evidence bundle locator pointer so downstream deployment consumers can compare desired current-pointer state against the current pointer without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

- Deployment verification receipt locator pointer reconciliation adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Materialize one reconciliation artifact over the deployment verification receipt locator pointer so downstream deployment consumers can compare desired current-pointer state against the current pointer without ad hoc shell checks.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

<!-- queue-snapshot: todo_sha256=1127d0e92649599e9302c53c32185a200367f020a4bf0103119c232b03965c39 parent_commit=caa448ee4c69b0c15c02caed01bd9fae9c00148f -->
