...
- Distributed shard lineage evidence bundle adapter [Distributed Training, Data Infra]
  - Goal: Package distributed shard lineage receipts plus their referenced shard metadata and checkpoint-root evidence into one stable bundle artifact so downstream lineage review tooling can consume a single entrypoint.
  - Kind: `mixed`
