...
- Keep the TODO queue strictly priority-ranked and maintain a stable visible horizon (default: 6 items). Append new lower-priority items at the bottom instead of reshaping the horizon.
