...
- Inference approved baseline history contract [Inference, Experimentation/Eval Infra]
  - Goal: Define a compact history artifact for approved baseline pointer changes so rollout tooling can audit baseline selection over time without replaying every approval, supersession, and rollback artifact manually.
  - Kind: `mixed`
