...
- Deployment verification receipt rollback history adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Append one compact history artifact over deployment verification receipt rollback changes so downstream deployment tooling can audit rollback-driven verification receipt updates without reading shell or process logs.
  - Kind: `mixed`
  - Boundary: `adapter-deployment`
  - Contracts: `artifact`, `event`, `ops`
  - Scope: `src/`, `fixtures/`, `tests/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `docs/adr/`

<!-- queue-snapshot: todo_sha256=7f9f44e56c5d38bc94f297d255b0bb68c1333e1eac4b5a91024f80bef21c0737 parent_commit=2e3de18d7cfc03a69544f34d6a5ef251dc5c4236 -->
