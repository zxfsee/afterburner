...
- Public CLI admission gate [Runtime Infra, Serving/Deployment Infra]
  - Goal: Turn the operator command matrix into an executable gate so the public CLI stays limited to the allowed grouped families and flat taxonomy-heavy command shapes cannot resurface unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `cli`, `docs`
  - Scope: `justfile`, `docs/workflows.md`, `docs/reference.md`, `tests/cli_subcommand_hierarchy.rs`, `tests/debug_deploy_taxonomy_regression.rs`, `tests/public_cli_admission_gate.rs`
...
<!-- queue-snapshot: todo_sha256=644e6b7c7281bfe8f8199c67735a84353c5bb6140b3544a327eff2c6ae29bb52 parent_commit=0c3abc5f7ce0b53b25bd585712a95e226a6c0340 -->
