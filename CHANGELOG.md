...
- Training scalability-readiness contract [Distributed Training, Runtime Infra]
  - Goal: Make training path scalability-ready (not scaled yet) by defining/validating contract-level controls and observability for batch size, worker parallelism, and deterministic throughput reporting.
  - Kind: `mixed`
