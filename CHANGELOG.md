...
- Grouped drift reference split validation gate alignment [Experimentation/Eval Infra]
  - Goal: Keep the shared README/reference split validator aligned with the drift reference family so drift artifact groups cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

<!-- queue-snapshot: todo_sha256=ba155d48144dcce0dde572044394db8f1a4aacf8b8a467f1fb1aae5c3a5a5361 parent_commit=54d8d9320666705a7fafc6abcb1fbd36345efa0f -->
