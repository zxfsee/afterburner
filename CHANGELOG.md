...
- Queue resume and completion-boundary hardening [Runtime Infra, Serving/Deployment Infra]
  - Goal: Add a first-class repair-and-resume path for stale queue snapshot lineage, add a distinct completion-boundary guard for completed TODOs left active, and enforce the new workflow-hardening preemption rule before normal queue advancement resumes.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `cli`
  - Scope: `AGENTS.md`, `justfile`, `src/bin/`, `tests/`, `docs/workflows.md`
...
<!-- queue-snapshot: todo_sha256=2474d9c811aec4278f2b5ea73b214bf54c0fb0481c3fa036c491ec2af8def6ab parent_commit=14099dd86fe393efa4c7dd5412d9bfff4aac54b1 -->
