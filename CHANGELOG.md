...
- Inference drift policy profile contract [Inference, Experimentation/Eval Infra]
  - Goal: Define a named drift-policy profile artifact so drift receipts and baseline snapshots use one explicit threshold contract instead of ad-hoc CLI thresholds at rollout time.
  - Kind: `mixed`
