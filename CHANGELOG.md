...
- Grouped deployment-stack launch artifact split validation gate alignment [Serving/Deployment Infra]
  - Goal: Keep the shared README/reference split validator aligned with the deployment-stack launch artifact cluster so the grouped launch reference surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

- Grouped deployment-verification receipt and handoff artifact split validation gate alignment [Serving/Deployment Infra]
  - Goal: Keep the shared README/reference split validator aligned with the remaining deployment-verification receipt and handoff artifact cluster so the grouped verification reference surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

- Grouped deployment-stack transport/locator artifact split validation gate alignment [Serving/Deployment Infra]
  - Goal: Keep the shared README/reference split validator aligned with the deployment-stack transport and locator artifact cluster so the grouped deployment-stack locator surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

- Grouped deployment-stack check artifact split validation gate alignment [Serving/Deployment Infra]
  - Goal: Keep the shared README/reference split validator aligned with `deployment_stack_check.json` so the grouped deployment-stack check surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

- Grouped training/inference artifact and event split validation gate alignment [Inference, Runtime Infra]
  - Goal: Keep the shared README/reference split validator aligned with the top training and inference contract artifacts and events so the front-section reference surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`
...
<!-- queue-snapshot: todo_sha256=30e5d9c69473f9afbc44284b117c8d02817af04d8425d7fb2c2e81c744291d67 parent_commit=46bb5d27545d5511ca41f3d2de726dfc171a83a2 -->
...
- Drop stale drift section split gate ([86bc08b])
...
- Align deployment-utility split artifacts ([55c6993])
- Align kube-lease split cluster ([e35127a])
- Align rollout split artifacts ([db8c680])
...
[86bc08b]: https://github.com/zxfsee/afterburner/commit/86bc08b6a8b78a0a191e3ce94463ed705f23a002
[cbe98b7]: https://github.com/zxfsee/afterburner/commit/cbe98b77b332dc8166733138d3382f669832a550
[55c6993]: https://github.com/zxfsee/afterburner/commit/55c69934ae948e8be6cd5a7034ae723331322350
[3beb017]: https://github.com/zxfsee/afterburner/commit/3beb01790cca0b333331dc9c249e2cf1688b01a1
[e35127a]: https://github.com/zxfsee/afterburner/commit/e35127af269adfcef87a9ae6fc4ed0001fab5a91
[db8c680]: https://github.com/zxfsee/afterburner/commit/db8c6800a7a27af86f95d63acc4c9132b7680124
[46bb5d2]: https://github.com/zxfsee/afterburner/commit/46bb5d27545d5511ca41f3d2de726dfc171a83a2
