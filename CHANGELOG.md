...
- GitHub repo metadata application checklist [Runtime Infra, Serving/Deployment Infra]
  - Goal: Record the exact GitHub settings targets for the repo metadata polish step so description, topics, and website/no-website decisions can be applied later without reopening the wording discussion.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `README.md`, `docs/reference.md`, `docs/workflows.md`

- GitHub repo metadata execution note [Runtime Infra, Serving/Deployment Infra]
  - Goal: Record the exact manual application sequence for GitHub description/topics/website metadata so the later repo-settings pass is one short deterministic step instead of another discussion round.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `README.md`, `docs/reference.md`, `docs/workflows.md`

- GitHub repo metadata ownership note [Runtime Infra, Serving/Deployment Infra]
  - Goal: Record where the repo metadata source of truth lives and what stays manual so later GitHub settings polish does not sprawl into duplicate doc surfaces.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `README.md`, `docs/reference.md`, `docs/workflows.md`

- GitHub repo metadata publish-ready copy block [Runtime Infra, Serving/Deployment Infra]
  - Goal: Produce one short, copy-ready description/topic block in the docs surface so the later GitHub settings update can be applied without recomposing the wording again.
  - Kind: `mixed`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `README.md`, `docs/reference.md`, `docs/workflows.md`

- GitHub repo metadata drift gate [Runtime Infra, Serving/Deployment Infra]
  - Goal: Add one focused docs gate that fails if the GitHub metadata candidates, checklist, execution note, ownership note, and publish-ready copy block drift apart after the metadata-doc pass lands.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/`, `README.md`, `docs/reference.md`, `docs/workflows.md`
...
<!-- queue-snapshot: todo_sha256=9128928f009dd8a51515d0a21db2baaa21a1ac8e710e275154c7762c907a946d parent_commit=680b32f5165f40f7391464525f8df93370d266e9 -->
