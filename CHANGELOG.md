...
- Grouped cleanup reference split validation gate alignment [Runtime Infra]
  - Goal: Keep the shared README/reference split validator aligned with the cleanup reference family so cleanup artifact groups cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

<!-- queue-snapshot: todo_sha256=499fd247d8b722e22c7fe9c1dc44e7d445b6b0f6ad7f5a26405d24d92c86d0b2 parent_commit=2ffac421fad4cfbfa83ea346bd6e06a0b1c63b37 -->
