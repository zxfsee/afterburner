...
- Profiling provenance evidence bundle adapter [Runtime Infra, Experimentation/Eval Infra]
  - Goal: Package profiling environment snapshot and hotspot summary provenance into one stable bundle artifact so downstream profiling review tooling can consume a single entrypoint instead of chasing separate artifacts manually.
  - Kind: `mixed`
