...
- Artifact cleanup evidence bundle adapter [Serving/Deployment Infra, Runtime Infra]
  - Goal: Package cleanup dry-run and execution receipts plus their referenced inventory/policy evidence into one stable bundle artifact so downstream cleanup review tooling can consume a single entrypoint.
  - Kind: `mixed`
