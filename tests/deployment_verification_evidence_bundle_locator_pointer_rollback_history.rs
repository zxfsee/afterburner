...
#[test]
fn deployment_verification_bundle_locator_pointer_rollback_history_schema_and_workflow_are_explicit()
 {
    ...
    assert!(
        ...
        "justfile must expose the deployment-verification-record-bundle-locator-rollback-history workflow"
    );
    ...
    assert!(
        ...
        "workflow reference must mention the deployment verification bundle locator rollback history artifact"
    );
    assert!(
        workflows.contains("just deployment-verification-record-bundle-locator-rollback-history"),
        "workflow reference must mention the deployment verification bundle locator rollback history workflow"
    );
}
