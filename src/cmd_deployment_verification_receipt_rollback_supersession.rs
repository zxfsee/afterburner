...
fn load_json_object(
    path: &Path,
    kind: &str,
) -> Result<serde_json::Map<String, Value>, DeploymentVerificationReceiptRollbackSupersessionError>
{
...
fn read_string(
    ...
    path: &Path,
    kind: &str,
) -> Result<String, DeploymentVerificationReceiptRollbackSupersessionError> {
    object
        .get(key)
