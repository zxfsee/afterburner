...
- Inference approved baseline rollback contract [Inference, Experimentation/Eval Infra]
  - Goal: Define a rollback record for switching the selected approved baseline back to the previous one so drift-management state changes remain reversible and explicit.
  - Kind: `mixed`
