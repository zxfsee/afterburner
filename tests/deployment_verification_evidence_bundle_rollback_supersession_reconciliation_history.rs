...
#[test]
fn deployment_verification_evidence_bundle_rollback_supersession_reconciliation_history_schema_and_workflow_are_explicit()
 {
    ...
    assert!(
        ...
        "justfile must expose the deployment-verification-record-bundle-rollback-supersession-reconciliation-history workflow"
    );
    ...
    assert!(
        ...
        "workflow reference must mention the deployment verification evidence bundle rollback supersession reconciliation history artifact"
    );
    assert!(
        workflows.contains(
            "just deployment-verification-record-bundle-rollback-supersession-reconciliation-history"
        ),
        "workflow reference must mention the deployment verification evidence bundle rollback supersession reconciliation history workflow"
    );
}
...
fn deployment_verification_evidence_bundle_rollback_supersession_reconciliation_history_writes_history_and_event()
 {
  ...
  "reconciliation_status": "aligned"
    ...
    cmd.arg("debug")
        .arg("deploy")
        .arg("record-verification-bundle-rollback-supersession-reconciliation-history")
        .arg("--reconciliation")
        .arg(&reconciliation)
        .arg("--event")
        .arg("reconciled")
