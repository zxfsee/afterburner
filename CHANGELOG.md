...
- Inference drift approved baseline pointer contract [Inference, Experimentation/Eval Infra]
  - Goal: Define a single selected approved-baseline pointer so rollout tooling can resolve the current approved baseline directly instead of searching or inferring across multiple approval and supersession artifacts.
  - Kind: `mixed`
