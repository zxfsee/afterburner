...
- Burn `.bpk` migration surface inventory report [Frameworks, Runtime Infra]
  - Goal: Materialize one explicit report of current `.mpk` contract touchpoints and cutover-sensitive surfaces so the later `.bpk` migration can execute as one contract change when a newer stable Burn release exists.
  - Kind: `mixed`
  - Boundary: `core-contract`
  - Contracts: `artifact`, `cli`, `event`
  - Scope: `Cargo.toml`, `CHANGELOG.md`, `src/`, `tests/`, `fixtures/`, `justfile`, `docs/workflows.md`, `docs/reference.md`, `README.md`, `ARCHITECTURE.md`, `docs/adr/`
...
- Burn `.bpk` artifact migration contract [Frameworks, Runtime Infra]
  ...
  - Blocked-by: Burn `.bpk` migration surface inventory report; newer stable Burn release after `0.20.1`; see ADR-033.
...
<!-- queue-snapshot: todo_sha256=dd3b815145fdd7c79329d6904bf3d2dda6e7ffd2eac73db8486503097904c309 parent_commit=4cd883e71bca83dddfce3aaf6f0b2a58baa302c0 -->
