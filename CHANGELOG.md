...
- Grouped source/lineage section split validation gate alignment [Data Infra, Distributed Training]
  - Goal: Keep the shared README/reference split validator aligned with the source and lineage section heading so the grouped source/lineage reference surface cannot drift unnoticed.
  - Kind: `gate`
  - Boundary: `repo-workflow`
  - Contracts: `docs`
  - Scope: `tests/readme_reference_split.rs`

<!-- queue-snapshot: todo_sha256=85e8a33e8616f19443f619e587ce5eb8103c2a014e26133a0f8ecc614d55c64f parent_commit=e53a7bea9698de4f6aa1e05db943aecb8b6b6b1d -->
