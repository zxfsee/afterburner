...
- Inference drift baseline refresh contract [Inference, Experimentation/Eval Infra]
  - Goal: Define a checked refresh workflow for replacing an approved infer drift baseline so policy, receipt, and baseline updates remain synchronized instead of drifting independently.
  - Kind: `mixed`
