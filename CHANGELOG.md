...
- README GitHub frontpage clarity pass [Runtime Infra, Serving/Deployment Infra]
  - Goal: Restructure `README.md` for GitHub frontpage readability so system shape, quick start, and primary workflows fit the first screen, line-wrapped text becomes real paragraphs, and deep operational/reference detail moves into `docs/`.
  - Kind: `mixed`
  - Boundary: `none`
  - Contracts: `none`
  - Scope: `README.md`, `docs/`, `tests/`, `ARCHITECTURE.md`
